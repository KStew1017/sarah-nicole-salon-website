        ...
        <>
            {isEditing ? (
                    ...
                    <div className="h-full min-w-full flex flex-col">
                        <Textarea
                            ...
                            classNames={{
                                ...
                                input: "font-serif text-[20px] text-green",
                                errorMessage:
                                    "font-serif text-red-600 text-[16px] absolute bottom-0 left-0 translate-y-[25px]",
                            }}
                        />
                ...
                <div className="h-full w-full flex flex-col items-center justify-center">
                    <p className="text-[24px] font-serif text-green text-center ">{textState}</p>
                    <Button
