import { faCaravan, faCross, faDog, faHouseChimneyWindow, faMotorcycle, faMusic, faPaintBrush, faPalette, faSailboat, faScissors } from "@fortawesome/free-solid-svg-icons";
    ...
    stylists: [
        {
            ...
            icons: [faHouseChimneyWindow, faDog, faScissors]
        },
        {
            ...
            paymentMethods: ["Cash", "Check", "Zelle"],
            icons: [faPalette, faMotorcycle, faCaravan]
        },
        {
            ...
            icons: [faSailboat, faMusic, faCross]
        },
        {
            name: "Misty Record",
            ...
            paymentMethods: ["Cash", "Check", "Zelle"],
            icons: [faPalette, faPaintBrush, faDog]
        },
    ],
    reviews: [
        {
