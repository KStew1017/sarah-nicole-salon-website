    ...
    stylists: [
        {
            ...
            services: ["Haircuts", "Coloring", "Styling", "Braiding", "Curly Hair Care", "Eyebrow Waxing"],
        ...
        },
        {
            ...
            services: ["Haircuts", "Coloring", "Styling", "Braiding", "Facial Waxing"],
            paymentMethods: ["Cash", "Check", "Zelle"],
        },
        {
            ...
            services: ["Haircuts", "Coloring", "Perms", "Roller Sets", "Children's Haircuts"],
        ...
        },
        {
            ...
            services: ["Nail Art", "Manicures", "Pedicures", "Dips", "Tips"],
            paymentMethods: ["Cash", "Check", "Zelle"],
        },
    ],
};
